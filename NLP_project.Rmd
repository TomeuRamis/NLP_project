...
balanced_data$dfm = dfm(balanced_data$tokens, remove = stopwords("english"), tolower=TRUE, stem = TRUE)
...
```{r}
#Naive Bayes text model with prior distribution on text set to 'termfreq'
nb_model_b <- textmodel_nb(train_b$dfm, train_b$Recommend, smooth=1, prior="termfreq")
summary(nb_model_b)
